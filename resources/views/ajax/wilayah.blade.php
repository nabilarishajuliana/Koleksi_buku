        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    <label>Provinsi<span id="spinner_prov" class="spinner-border spinner-border-sm text-primary d-none"></span></label>
                ...
                <div class="form-group mb-3">
                    <label>Kota<span id="spinner_kota" class="spinner-border spinner-border-sm text-primary d-none"></span></label>
                ...
                <div class="form-group mb-3">
                    <label>Kecamatan<span id="spinner_kec" class="spinner-border spinner-border-sm text-primary d-none"></span></label>
                ...
                <div class="form-group mb-3">
                    <label>Kelurahan<span id="spinner_kel" class="spinner-border spinner-border-sm text-primary d-none"></span></label>
...
<script>
    ...
    // function showLoading(selectId, placeholder) {
    //     const select = $('#' + selectId);
    //     select.empty();
    ...
    // ================================================================
    $(function() {
        showSpinner('spinner_prov'); // ← munculin spinner
        ...
        $.ajax({
            ...
            success: function(response) {
                hideSpinner('spinner_prov'); // ← sembunyiin spinner
        ...
        $('#ajax_provinsi').change(function() {
            ...
            showSpinner('spinner_kota'); // ← munculin spinner

            $.ajax({
                url: `/api/kota/${idProvinsi}`,
                method: 'GET',
                success: function(response) {
                    hideSpinner('spinner_kota'); // ← sembunyiin spinner
        ...
        $('#ajax_kota').change(function() {
            ...
            if (idKota === '') return;
            showSpinner('spinner_kec'); // ← munculin spinner
            ...
            $.ajax({
                ...
                method: 'GET',
                success: function(response) {
                    hideSpinner('spinner_kec'); // ← sembunyiin spinner
        ...
        $('#ajax_kecamatan').change(function() {
            ...
            showSpinner('spinner_kel'); // ← munculin spinner

            $.ajax({
                url: `/api/kelurahan/${idKecamatan}`,
                method: 'GET',
                success: function(response) {
                    hideSpinner('spinner_kel'); // ← sembunyiin spinner
